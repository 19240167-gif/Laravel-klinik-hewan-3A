        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('dokter-hewan.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="id_dokter_hewan" class="form-label">ID Dokter Hewan <span class="text-danger">*</span></label>
                        <input type="text" 
                               class="form-control @error('id_dokter_hewan') is-invalid @enderror" 
                               id="id_dokter_hewan" 
                               name="id_dokter_hewan" 
                               value="{{ old('id_dokter_hewan') }}"
                               maxlength="8"
                               placeholder="Contoh: DRH001"
                               required>
